              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                  <div className="space-y-4">
                    <h3 className="text-xl font-headline font-semibold border-b pb-2">Your Contact Information</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-xl font-headline font-semibold border-b pb-2">Property Details</h3>
                  ...
                  <div className="space-y-4">
                     <h3 className="text-xl font-headline font-semibold border-b pb-2">Additional Information</h3>
